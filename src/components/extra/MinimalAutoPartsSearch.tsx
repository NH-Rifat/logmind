            ...
            <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
              <div className="mb-8 md:mb-12">
                <h1 className="text-3xl md:text-5xl font-bold mb-4">
                  Найдите автозапчасти
                </h1>
                <p className="text-neutral-500 max-w-2xl">
                  Введите название или артикул запчасти, и мы мгновенно проверим
                  наличие в магазинах вашего города
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="h-14 px-8 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white"
                  >
                    Найти
                  </Button>
                </form>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    {
                      query: "Тормозные колодки Toyota Camry",
                      date: "2 часа назад",
                    },
          ...
          {activeSection === "how" && (
            <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
              <div className="mb-8 md:mb-12">
                ...
                <p className="text-neutral-500 max-w-2xl">
                  Наш сервис помогает быстро найти автозапчасти в наличии в
            ...
            <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
              <div className="mb-8 md:mb-12">
                ...
                <p className="text-neutral-500 max-w-2xl">
                  ...
                  системе и получайте новых клиентов
                </p>
              </div>
            ...
            <div>
              ...
              <div className="bg-neutral-50 rounded-xl p-4">
                <p className="text-sm text-neutral-600 mb-4">
                  Если у вас возникли вопросы по работе сервиса, свяжитесь с
                  нашей поддержкой
                </p>

                <Button
                  variant="outline"
                  className="w-full rounded-lg border-neutral-300"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-sm text-neutral-500">
              © {new Date().getFullYear()} АвтоПоиск
            </div>
          </div>
        </div>
      </footer>
