          ...
          <div className="container relative z-10 py-12 md:py-24 lg:py-32">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground">
                  Проверяйте наличие в магазинах и сервисах рядом с вами
                </p>
              </div>
            ...
            <Card className="mt-8 md:mt-12">
              <CardHeader>
                ...
                <CardDescription>
                  Введите название или артикул запчасти, выберите город и радиус
                  поиска
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <section className="container py-12 md:py-24">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Сервис мгновенно показывает, где в вашем городе есть нужные
              автозапчасти. Экономьте время — не обзванивайте магазины, не ждите
              доставки!
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="mt-4">
                  Актуальные данные о наличии
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Обновляем информацию о наличии запчастей в режиме реального
                  времени
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="mt-4">
                  Прямые контакты продавцов
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Звоните напрямую в магазины без посредников и дополнительных
                  комиссий
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Сортируйте результаты по цене, расстоянию, бренду и другим
                  параметрам
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Находите оригинальные и совместимые запчасти по коду
                  производителя
                </p>
              </CardContent>
            </Card>
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Укажите название или артикул запчасти, выберите город и
                    радиус поиска
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Наша система мгновенно проверяет наличие запчастей в тысячах
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle>
                    Получите список адресов, цен и телефонов
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Выбирайте лучшее предложение по цене и расположению, звоните
                    напрямую продавцу
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="container py-12 md:py-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Card
                key={index}
                className="text-center hover:border-primary cursor-pointer transition-colors"
              >
        ...
        <section className="container py-12">
          ...
          <div className="h-[400px] bg-muted rounded-lg flex items-center justify-center border">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Здесь будет отображаться карта с магазинами автозапчастей
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="italic mb-4">
                    Нашел глушитель за полцены в соседнем районе — спас сервис!
                    Не пришлось ждать доставку из другого города.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="italic mb-4">
                    Срочно нужны были тормозные колодки. Через сервис нашел в
                    магазине в 15 минутах от дома. Очень удобно!
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="italic mb-4">
                    Экономит кучу времени! Раньше обзванивала все магазины,
                    теперь просто ввожу запчасть и вижу, где есть в наличии
                  </p>
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="text-lg opacity-90">
                Тысячи автовладельцев уже экономят время и деньги с нашим
                сервисом
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Владеете магазином автозапчастей или СТО? Подключитесь к нашей
                системе и получайте новых клиентов каждый день.
              </p>
      ...
      <footer className="border-t bg-muted/40">
        <div className="container py-8 md:py-12">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Сервис поиска автозапчастей в наличии в вашем городе
              </p>
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} АвтоЗапчасти.Поиск. Все права
              защищены.
            </p>
          </div>
        </div>
