            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-6 max-w-xl">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-neutral-900">
                  ...
                  <span className="text-blue-600">за минуту</span>
                </h1>

                <p className="text-xl text-neutral-600">
                  Мгновенно проверяйте наличие автозапчастей в магазинах вашего
                  города и сравнивайте цены
                </p>
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-lg p-4 max-w-[240px]">
                    ...
                    <p className="text-sm text-neutral-600">
                      Среднее время поиска запчасти — 47 секунд
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold mb-4">
                  Найдите нужную запчасть прямо сейчас
                </h2>
                ...
                <CardContent className="p-0">
                  <div className="bg-blue-600 p-4 md:p-6">
                    <div className="flex flex-wrap gap-4 mb-4">
                      ...
                      <Button
                        variant={
                          activeTab === "original" ? "secondary" : "ghost"
                        }
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-neutral-600">
                Мы создали удобный инструмент для быстрого поиска автозапчастей,
              ...
              {[
                {
                  ...
                  description:
                    "Не нужно обзванивать десятки магазинов. Все результаты в одном месте за секунды.",
                },
                {
                  icon: <Settings className="h-6 w-6 text-blue-600" />,
                  title: "Актуальные данные",
                  description:
                    "Информация о наличии и ценах обновляется в режиме реального времени.",
                },
                {
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              {[
                ...
                },
                {
                  ...
                  description:
                    "Система мгновенно проверит наличие в тысячах магазинов вашего города",
                },
                {
                  step: 3,
                  title: "Выберите лучшее предложение",
                  description:
                    "Сравните цены, расположение и наличие, свяжитесь напрямую с продавцом",
                },
              ].map((step, index) => (
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Находите магазины на карте
                </h2>
                <p className="text-lg text-neutral-600 mb-8">
                  Интерактивная карта показывает все магазины с нужными
                  запчастями. Выбирайте ближайшие точки и прокладывайте маршрут.
                </p>
        ...
        <section id="testimonials" className="py-16 md:py-24 bg-white">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-neutral-600">
                Что говорят о нашем сервисе те, кто уже нашел нужные запчасти
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-600">
                Сотрудничаем с ведущими поставщиками автозапчастей
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-8 items-center">
              {[1, 2, 3, 4, 5].map((partner) => (
                <div
                  key={partner}
                  className="h-16 w-40 bg-white rounded-xl shadow-sm flex items-center justify-center"
                >
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="h-12 rounded-full bg-blue-600 hover:bg-blue-700"
                  >
              ...
              <div>
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    "Интеграция с вашей системой учета",
                    "Только целевые клиенты",
                  ].map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className="mt-1 h-5 w-5 rounded-full bg-green-50 flex items-center justify-center">
                        <Check className="h-3 w-3 text-green-600" />
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600">
                          Привлекайте новых клиентов через нашу платформу
                        </p>
                      </div>
                      <Button
                        variant="outline"
